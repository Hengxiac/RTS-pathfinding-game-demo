...
namespace CharacterControl {
	...
	namespace Events
	{
		...
		struct SoldierNPCMovementSM_Event_SHOOT_TO : public PE::Events::Event {
			PE_DECLARE_CLASS(SoldierNPCMovementSM_Event_SHOOT_TO);

			SoldierNPCMovementSM_Event_SHOOT_TO(Vector3 targetPos = Vector3());
	...
	namespace Components {
		...
		struct SoldierNPCMovementSM : public PE::Components::Component
		{
			...
			//
			PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_SoldierNPCMovementSM_Event_SHOOT_TO)
				virtual void do_SoldierNPCMovementSM_Event_SHOOT_TO(PE::Events::Event *pEvt);
			//
			...
			PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_PRE_PHYSICS)
				virtual void do_PRE_PHYSICS(PE::Events::Event *pEvt);

			PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_POST_PHYSICS)
				virtual void do_POST_PHYSICS(PE::Events::Event *pEvt);
