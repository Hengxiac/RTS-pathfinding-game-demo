...
namespace CharacterControl {
	namespace Components {
		...
		Target::Target(PE::GameContext &context, PE::MemoryArena arena, PE::Handle hMyself, Event_CreateTarget *pEvt) : Component(context, arena, hMyself)
		{
...
/*
			...
			PE::Handle hTargetMovementSM("TargetMovementSM", sizeof(TargetMovementSM));
			TargetMovementSM *pTargetMovementSM = new(hTargetMovementSM) TargetMovementSM(*m_pContext, m_arena, hTargetMovementSM);
			...
			PE::Handle hTargetBehaviorSM("TargetBehaviorSM", sizeof(TargetBehaviorSM));
			TargetBehaviorSM *pTargetBehaviorSM = new(hTargetBehaviorSM) TargetBehaviorSM(*m_pContext, m_arena, hTargetBehaviorSM, hTargetMovementSM);
			pTargetBehaviorSM->addDefaultComponents();

			// add it to soldier NPC
			addComponent(hTargetBehaviorSM);

			StringOps::writeToString(pEvt->m_movementWayPoint, pTargetBehaviorSM->m_curPatrolWayPoint, 32);
