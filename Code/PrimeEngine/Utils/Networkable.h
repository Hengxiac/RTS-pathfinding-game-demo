...
struct Networkable
{
	...
	virtual int packCreationData(char *pDataStream /*, bool* stateMask = NULL*/){assert(!"This function is not overridden by this class and should not be called! Make sure to implement override of this function in current class"); return 0;}
