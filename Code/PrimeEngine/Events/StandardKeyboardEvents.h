...
struct Event_KEY_E_HELD : public Event {
	PE_DECLARE_CLASS(Event_KEY_E_HELD);
	virtual ~Event_KEY_E_HELD() {}
};
...
struct Event_MOUSE_RIGHT_HELD : public Event {
	PE_DECLARE_CLASS(Event_MOUSE_RIGHT_HELD);
	virtual ~Event_MOUSE_RIGHT_HELD() {}
	float x, y;
	bool shiftHeld;
	bool pHeld;
};

struct Event_MOUSE_LEFT_HELD : public Event {
	PE_DECLARE_CLASS(Event_MOUSE_LEFT_HELD);
	virtual ~Event_MOUSE_LEFT_HELD() {}
	float x, y;
	bool ctrlHeld;
};

struct Event_FUN_KEY_HELD : public Event {
	PE_DECLARE_CLASS(Event_FUN_KEY_HELD);
	virtual ~Event_FUN_KEY_HELD() {}
	int num;
	bool ctrlHeld;
};

struct Event_NUM_KEY_HELD : public Event {
	PE_DECLARE_CLASS(Event_NUM_KEY_HELD);
	virtual ~Event_NUM_KEY_HELD() {}
	int num;
	bool ctrlHeld;
};
}; // namespace Events
