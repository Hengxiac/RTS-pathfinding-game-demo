...
namespace Events {
	...
	PE_IMPLEMENT_CLASS1(Event_UPDATE_TARGET_POS, Event);
	PE_IMPLEMENT_CLASS1(Event_CHECK_SELECTED, Event);
	PE_IMPLEMENT_CLASS1(Event_UPDATE_GROUP, Event);
//////////////////////////////////////////////////////////////////////////
// Event_POP_SHADERS
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
// Event_CREATE_NAVMESH
//////////////////////////////////////////////////////////////////////////

PE_IMPLEMENT_CLASS1(Event_CREATE_NAVMESH, Event);

void Event_CREATE_NAVMESH::SetLuaFunctions(PE::Components::LuaEnvironment *pLuaEnv, lua_State *luaVM)
{
	...
	// register the functions in current lua table which is the table for Event_CREATE_NAVMESH
	luaL_register(luaVM, 0, l_Event_CREATE_NAVMESH);
}

// this function is called form lua whenever Lua wants to create an event
int Event_CREATE_NAVMESH::l_Construct(lua_State* luaVM)
{
	Handle h("EVENT", sizeof(Event_CREATE_NAVMESH));
	PE::GameContext *pContext = (PE::GameContext*)(lua_touserdata(luaVM, -16));

	Event_CREATE_NAVMESH *pEvt = new(h) Event_CREATE_NAVMESH(pContext->m_gameThreadThreadOwnershipMask);
...
PE_IMPLEMENT_CLASS1(Event_PRE_PHYSICS, Event);
PE_IMPLEMENT_CLASS1(Event_POST_PHYSICS, Event);
PE_IMPLEMENT_CLASS1(Event_PHYSICS_UPDATE, Event);
//////////////////////////////////////////////////////////////////////////
//
//////////////////////////////////////////////////////////////////////////
...
PE_IMPLEMENT_CLASS1(Event_Resolve_Collision, Event);
...
PE_IMPLEMENT_CLASS1(Event_Update_Ghost, Event);

int Event_Update_Ghost::constructFromStream(char* pDataStream)
{
	int read = 0;
	for (int i = 0; i < PE::Components::GhostManager::MASK_SIZE; i++)
	{
		read += PE::Components::StreamManager::ReadBool(&pDataStream[read], stateMask[i]);
	}

	bool flag = true;
	if (stateMask[0] && flag)
	{
		read += PE::Components::StreamManager::ReadInt32(&pDataStream[read], m_intVal[0]);
	}
	
	if (stateMask[1] && flag)
	{
		read += PE::Components::StreamManager::ReadInt32(&pDataStream[read], m_intVal[1]);
	}
	...
	if (stateMask[3])
	{
		read += PE::Components::StreamManager::ReadMatrix4x4(&pDataStream[read], m_transform2);
	}
	return read;
}

PE_IMPLEMENT_CLASS1(Event_Create_Ghost, Event_Update_Ghost);

int Event_Create_Ghost::constructFromStream(char *pDataStream)
{
	int read = 0;
	read += PE::Components::StreamManager::ReadInt32(&pDataStream[read], m_ghostType);
	read += Event_Update_Ghost::constructFromStream(&pDataStream[read]);
	return read;
}

PE_IMPLEMENT_CLASS1(Event_Destroy_Ghost, Event_Create_Ghost);

int Event_Destroy_Ghost::constructFromStream(char *pDataStream)
{
	int read = 0;
	read += Event_Create_Ghost::constructFromStream(&pDataStream[read]);
	return read;
}
PE_IMPLEMENT_CLASS1(Event_SEND_GHOST_TO_NEW_CLIENT, Event);
