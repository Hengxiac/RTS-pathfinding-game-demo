...
namespace CameraOps
{
	...
	Matrix4x4 CreateScreenMatrix(PrimitiveTypes::Int16 DimX, PrimitiveTypes::Int16 DimY) {
		Matrix4x4 res2;

		res2.m[0][0] = DimX / 2.0f;
		res2.m[0][1] = 0.0f;
		res2.m[0][2] = 0.0f;
		res2.m[0][3] = DimX / 2.0f;

		res2.m[1][0] = 0.0f;
		res2.m[1][1] = -DimY / 2.0f;
		res2.m[1][2] = 0.0f;
		res2.m[1][3] = DimY / 2.0f;
