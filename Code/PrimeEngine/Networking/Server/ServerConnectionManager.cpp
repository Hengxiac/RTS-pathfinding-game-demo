...
ServerConnectionManager::ServerConnectionManager(PE::GameContext &context, PE::MemoryArena arena, PE::NetworkContext &netContext, Handle hMyself, SA* clientAddr)
: ConnectionManager(context, arena, netContext, hMyself, clientAddr)
{
