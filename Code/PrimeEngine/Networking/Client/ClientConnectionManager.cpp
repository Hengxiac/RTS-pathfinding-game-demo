...
ClientConnectionManager::ClientConnectionManager(PE::GameContext &context, PE::MemoryArena arena, PE::NetworkContext &netContext, Handle hMyself, SA* serverAddr)
: ConnectionManager(context, arena, netContext, hMyself, serverAddr)
{
}
